<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Что делать после обработки и надолго ли останется запах?',
    'longtitle' => 'Химия для дезинфекции без запаха или с запахом?',
    'description' => '',
    'alias' => 'chto-delat-posle-obrabotki-i-nadolgo-li-ostanetsya-zapax',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
...
<p>Думаете с чего дезинфекцию &mdash; закажите наш бесплатный просчет с мини аудитом. Вы получите: оценку стоимости и сроков поискового продвижения, а так же, перечень основных ошибок которые мешают вашему сайту выйти в ТОП.</p>',
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'chto-delat-posle-obrabotki-i-nadolgo-li-ostanetsya-zapax.html',
    'uri_override' => 0,
...
<html lang="ru">
    <head>
        <title>Что делать после обработки и надолго ли останется запах? - MODX Revolution</title>
<base href="[[!++site_url]]" />
<meta charset="UTF-8" />
...
<script type="application/ld+json">
    {
        ...
        "@type": "Article",
        "name": "Что делать после обработки и надолго ли останется запах?",
        "image": "http://xn----7sbbdnnl0aoutg1a7k.xn--p1ai/assets/images/logo.png",
        "author": "санэпид-служба.рф",
        "headline": "Что делать после обработки и надолго ли останется запах?",
        ...
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "http://xn----7sbbdnnl0aoutg1a7k.xn--p1ai/chto-delat-posle-obrabotki-i-nadolgo-li-ostanetsya-zapax.html"
        }
    }
</script>
<meta property="og:locale" content="ru_RU" />
<meta property="og:site_name" content="Что делать после обработки и надолго ли останется запах?">
<meta property="og:title" content="Что делать после обработки и надолго ли останется запах?" />
<meta property="og:description" content="" />
<meta property="og:url" content="http://xn----7sbbdnnl0aoutg1a7k.xn--p1ai/chto-delat-posle-obrabotki-i-nadolgo-li-ostanetsya-zapax.html" />
...
<meta property="article:published_time" content="2020-12-25 01:13:00" />
    ...
    <ol class="breadcrumb"><li class="breadcrumb-item"><a href="/">Главная</a></li>&nbsp;/&nbsp;<li class="breadcrumb-item"><a href="stati/">Статьи</a></li>&nbsp;/&nbsp;<li class="breadcrumb-item active">Что делать после обработки и надолго ли останется запах?</li></ol>
</div>
                <div id="page">
                    <div class="news">
                        <div class="sidebar">
                            <div class="last-news">
                                ...
                                <div class="list-news"><a href="ximiya-dlya-dezinfekczii-bez-zapaxa-ili-s-zapaxom.html"  class="first"><div class="news-card"><span>Химия для дезинфекции без запаха или с запахом?</span></div></a><a href="travlya-tarakanov-samostoyatelno-svoimi-silami.html" ><div class="news-card"><span>Травля тараканов самостоятельно своими силами</span></div></a><a href="chto-delat-posle-obrabotki-i-nadolgo-li-ostanetsya-zapax.html"  class="active"><div class="news-card"><span>Что делать после обработки и надолго ли останется запах?</span></div></a><a href="professionalnoe-unichtozhenie-klopov-garantiruet-100-rezultat.html"  class="last"><div class="news-card"><span>Профессиональное уничтожение клопов гарантирует 100% результат?</span></div></a></div>
                                <div class="show-more">
                        ...
                        <div class="content">
                            <article>
                                <h1>Химия для дезинфекции без запаха или с запахом?</h1>
                                <img class="article-image" src="assets/images/article.jpg" alt="Что делать после обработки и надолго ли останется запах?" />
        ...
        <div class="modal-content">
            <div style="border: solid 15px #fff; padding: 25px;">
                ...
                <div class="modal-body">
                    <form action="chto-delat-posle-obrabotki-i-nadolgo-li-ostanetsya-zapax.html" method="post">
...
',
  ...
  'elementCache' => 
  array (
    '[[~39? &scheme=`full`]]' => 'http://xn----7sbbdnnl0aoutg1a7k.xn--p1ai/chto-delat-posle-obrabotki-i-nadolgo-li-ostanetsya-zapax.html',
...
<meta property="og:image:secure_url" content="http://xn----7sbbdnnl0aoutg1a7k.xn--p1ai/assets/images/logo.png" />
<meta property="article:published_time" content="2020-12-25 01:13:00" />',
    '[[$head]]' => '<title>Что делать после обработки и надолго ли останется запах? - MODX Revolution</title>
<base href="[[!++site_url]]" />
<meta charset="UTF-8" />
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
